...
function descobreOferta(sti, status,situacao,filaChamado,numchamado) {
  ...
  ofertaCamisa10 = ["(STI13565)", "(STI13566)", "(STI13567)"],
	...
	ofertaNovoMES = ["(STI12156)", "(STI12150)", "(STI12151)", "(STI12155)", "(STI12153)", "(STI12154)", "(STI12152)", "(STI12164)", "(STI12163)", "(STI12166)",
"(STI12165)", "(STI12168)", "(STI12162)", "(STI12167)", "(STI12161)", "(STI12157)", "(STI12159)", "(STI12158)", "(STI12160)",
"(STI15330)","(CENG8756)","(STI8106)","(STI1703)","(STI14078)"],
  ...
  if (ofertaInvetarioEletronico.indexOf(sti) > -1) {
    ...
    return;
  }else if (ofertaPPMS.indexOf(sti) > -1) {
    status == "Aguardando tratamento" && !filaChamado.includes('Projetos') ? aguardandoPPMS++ : (status == "Em tratamento"  ? tratamentoPPMS++ : "");
